...
public interface IOutboxStorage
{
    ...
    /// </summary>
    Task Save(IDbConnection dbConnection, IEnumerable<AbstractRebusTransport.OutgoingMessage> outgoingMessages);
    ...
    /// <summary>
    /// Gets whether the message with the given <paramref name="messageId"/> has been marked as processed by <paramref name="sourceQueue"/>
    /// </summary>
    Task<bool> HasProcessedMessage(IDbConnection connection, string sourceQueue, string messageId);
